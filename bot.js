// bot.js — ПОЛНОСТЬЮ РАБОЧАЯ ВЕРСИЯ ДЛЯ ФЬЮЧЕРСОВ
...
// 📈 Список 200+ криптовалют — полный список для фьючерсов
export const CRYPTO_PAIRS = [
    "BTC-USDT", "ETH-USDT", "BNB-USDT", "SOL-USDT", "XRP-USDT", "ADA-USDT", "DOGE-USDT", "TON-USDT", "AVAX-USDT", "SHIB-USDT",
    "LINK-USDT", "BCH-USDT", "DOT-USDT", "LTC-USDT", "NEAR-USDT", "MATIC-USDT", "ICP-USDT", "APT-USDT", "UNI-USDT", "STX-USDT",
    "FET-USDT", "RNDR-USDT", "ATOM-USDT", "IMX-USDT", "INJ-USDT", "OP-USDT", "HBAR-USDT", "TIA-USDT", "RUNE-USDT", "AR-USDT",
    "MKR-USDT", "SUI-USDT", "SEI-USDT", "AAVE-USDT", "GRT-USDT", "FIL-USDT", "LDO-USDT", "MINA-USDT", "ALGO-USDT", "EGLD-USDT",
    "FLOW-USDT", "QNT-USDT", "AXS-USDT", "MANA-USDT", "SAND-USDT", "THETA-USDT", "VET-USDT", "XLM-USDT", "EOS-USDT", "XTZ-USDT",
    "KAVA-USDT", "GALA-USDT", "DYDX-USDT", "CRV-USDT", "SNX-USDT", "KSM-USDT", "ZIL-USDT", "CHZ-USDT", "ENJ-USDT", "BAT-USDT",
    "ZEC-USDT", "DASH-USDT", "NEXO-USDT", "COMP-USDT", "YFI-USDT", "CAKE-USDT", "1INCH-USDT", "LRC-USDT", "OMG-USDT", "CELO-USDT",
    "AMP-USDT", "ANKR-USDT", "AUDIO-USDT", "BAND-USDT", "BLZ-USDT", "C98-USDT", "CTSI-USDT", "CVC-USDT", "DGB-USDT", "DNT-USDT",
    "ELF-USDT", "FLUX-USDT", "FTM-USDT", "FXS-USDT", "GAS-USDT", "GLMR-USDT", "GMT-USDT", "GODS-USDT", "HIGH-USDT", "HNT-USDT",
    "ICX-USDT", "IOST-USDT", "IOTA-USDT", "JASMY-USDT", "JOE-USDT", "JST-USDT", "KDA-USDT", "KLAY-USDT", "LINA-USDT", "LOKA-USDT",
    "LPT-USDT", "LQTY-USDT", "LUNA-USDT", "MASK-USDT", "MDT-USDT", "METIS-USDT", "MOVR-USDT", "MTL-USDT", "NKN-USDT", "OCEAN-USDT",
    "OGN-USDT", "ONT-USDT", "ORN-USDT", "OXT-USDT", "PERP-USDT", "PHA-USDT", "PIVX-USDT", "POLY-USDT", "POWR-USDT", "PYR-USDT",
    "QI-USDT", "QTUM-USDT", "RAD-USDT", "REEF-USDT", "REN-USDT", "REQ-USDT", "RLC-USDT", "RSR-USDT", "RVN-USDT", "SFP-USDT",
    "SKL-USDT", "SLP-USDT", "SNM-USDT", "SNT-USDT", "STORJ-USDT", "SUSHI-USDT", "SXP-USDT", "TFUEL-USDT", "TOMO-USDT", "TRB-USDT",
    "TUSD-USDT", "UMA-USDT", "UTK-USDT", "VTHO-USDT", "WAVES-USDT", "WAXP-USDT", "WOO-USDT", "XEM-USDT", "XMR-USDT", "XNO-USDT",
    "XVS-USDT", "YGG-USDT", "ZRX-USDT", "ACH-USDT", "AGLD-USDT", "AKRO-USDT", "ALCX-USDT", "ALICE-USDT", "ALPHA-USDT", "ARPA-USDT",
    "ASTR-USDT", "ATA-USDT", "AUCTION-USDT", "BADGER-USDT", "BAL-USDT", "BICO-USDT", "BOND-USDT", "BSW-USDT", "BURGER-USDT", "CELR-USDT",
    "CHESS-USDT", "CHR-USDT", "CLV-USDT", "COTI-USDT", "CRO-USDT", "CTK-USDT", "DAR-USDT", "DENT-USDT", "DEXE-USDT", "DIA-USDT",
    "DODO-USDT", "DREP-USDT", "DUSK-USDT", "EDU-USDT", "EFI-USDT", "ELON-USDT", "ERN-USDT", "FIDA-USDT", "FLM-USDT", "FOR-USDT",
    "FRONT-USDT", "FUN-USDT", "GHST-USDT", "GLM-USDT", "GNS-USDT", "GTC-USDT", "HARD-USDT", "HERO-USDT", "HOT-USDT", "IDEX-USDT",
    "ILV-USDT", "IOTX-USDT", "IRIS-USDT", "JUV-USDT", "KNC-USDT", "KP3R-USDT", "LAZIO-USDT", "LIT-USDT", "MAGIC-USDT", "MBL-USDT",
    "MIR-USDT", "NBS-USDT", "NMR-USDT", "OM-USDT", "OOKI-USDT", "PARA-USDT", "PAXG-USDT", "PEOPLE-USDT", "PERL-USDT", "PLA-USDT",
    "PNT-USDT", "PROS-USDT", "PUNDIX-USDT", "QLC-USDT", "RARE-USDT", "RAY-USDT", "ROSE-USDT", "SPELL-USDT", "SRM-USDT", "STMX-USDT",
    "STPT-USDT", "STRAX-USDT", "SUN-USDT", "SYS-USDT", "TCT-USDT", "TKO-USDT", "TLM-USDT", "TVK-USDT", "UFT-USDT", "UNFI-USDT",
    "VGX-USDT", "VIB-USDT", "VIDT-USDT", "VITE-USDT", "VOXEL-USDT", "WAN-USDT", "WING-USDT", "WNXM-USDT", "WRX-USDT", "ZEN-USDT"
];
...
let botSettings = {
    ...
    maxConcurrentRequests: 10 // ✅ Максимум 10 параллельных запросов для защиты от rate limit
};
...
async function executeSingleTrade(symbol, forcedSide = null, klines = null) {
    ...
    try {
        ...
        if (forcedSide) {
            ...
            if (buyWeight > sellWeight && buyWeight > 0.3) { // ✅ Уменьшили порог для большего количества сделок
                signal = 'BUY';
                confidence = buyWeight;
                analysisReason = `Покупка: ${buySignals.map(s => s.type).join(', ')}`;
            } else if (sellWeight > buyWeight && sellWeight > 0.3) { // ✅ Уменьшили порог
                signal = 'SELL';
        ...
        if (botSettings.useDemoMode) {
            ...
            const [base, quote] = symbol.split('-');
            // ✅ Для фьючерсов баланс возвращается как account.balance
            quoteBalance = account.balance ? parseFloat(account.balance) : 0;
            baseBalance = 0; // В фьючерсах нет базового актива в балансе
            ...
            if (botSettings.useStopLoss || botSettings.useTakeProfit) {
                ...
                try {
                    if (botSettings.useStopLoss) {
                        ...
                        if (botSettings.useDemoMode) {
                            console.log(`[🎮 DEMO SL] 🛑 Stop-Loss для ${symbol}: ${slPrice.toFixed(8)} ${slSide}`);
                    ...
                    if (botSettings.useTakeProfit) {
                        ...
                        if (botSettings.useDemoMode) {
                            console.log(`[🎮 DEMO TP] 🎯 Take-Profit для ${symbol}: ${tpPrice.toFixed(8)} ${tpSide}`);
...
// ✅ Параллельный анализ всех пар с ограничением на количество одновременных запросов
export async function executeTradingLogic() {
    console.log("[🔄] Запуск параллельного анализа всех 200+ пар...");
    ...
    for (let i = 0; i < CRYPTO_PAIRS.length; i += batchSize) {
        ...
        // Пауза между батчами для защиты от rate limit
